...
public class Doacao {
    ...
    /**
     * @return the cod_doacao
     */
    public String getCod_doacao() {
        return cod_doacao;
    }

    /**
     * @param cod_doacao the cod_doacao to set
     */
    public void setCod_doacao(String cod_doacao) {
