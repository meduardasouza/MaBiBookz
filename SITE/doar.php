...
if(document.cadastro.livro.value=="")
{
alert("O Campo nome do livro é obrigatório!");
return false;
}
if(document.cadastro.exemplar.value=="")
{
alert("O Campo quantidade de exemplares é obrigatório!");
return false;
}
else
...
<form id="cadastro" name="cadastro" method="post" action="cadastro.php" onsubmit="return validaCampo(); return false;">
  <table width="625" border="0">
    ...
    <tr>
      ...
      <td width="546"><input name="livro" type="text" id="livro" size="70" maxlength="500" />
        <span class="style1">*</span></td>
    </tr>
	<tr>
      <td width="69">Quantidade de Exemplares:</td>
      <td width="546"><input name="exemplar" type="text" id="exemplar" size="70" maxlength="500" />
        <span class="style1">*</span></td>
    </tr>
    ...
    <tr>
      <td colspan="2"><p>
        <input name="cadastrar" type="submit" id="cadastrar" value="Concluir Doação!" />
